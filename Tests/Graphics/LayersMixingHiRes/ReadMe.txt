...
The border colour is expected to be overriden by HiRes configuration (should be "pink"
in the end, falling through paper+border transparency to "fallback" colour).
